...
- [ ] 1. Set up project structure, dependencies, and core interfaces
  - [ ] 1.1 Create directory structure and install dependencies
...
- [ ] 2. Implement Code Parser
  - [ ] 2.1 Implement `parseProject` in `src/parser/codeParser.ts`
...
- [ ] 3. Implement Graph Builder
  - [ ] 3.1 Implement `buildGraph` in `src/graph/graphBuilder.ts`
...
- [ ] 4. Implement Test Mapper
  - [ ] 4.1 Implement `buildTestMap` in `src/parser/testMapper.ts`
...
- [ ] 6. Implement Impact Engine
  - [ ] 6.1 Implement `computeBlastRadius` in `src/analysis/impactEngine.ts`
...
- [ ] 7. Implement Webview Provider and Panel Lifecycle
  - [ ] 7.1 Implement `BlastRadiusPanel` in `src/webview/webviewProvider.ts`
  ...
  - [ ] 7.2 Implement data privacy check
...
- [ ] 8. Implement Webview Client (Cytoscape.js Rendering)
  - [ ] 8.1 Create webview HTML and JavaScript
  ...
  - [ ] 8.2 Implement graph rendering from `graph-data` messages
  ...
  - [ ] 8.3 Implement node click handling and highlight application
  ...
  - [ ] 8.4 Implement Impact Summary sidebar rendering
...
- [ ] 9. Wire everything together in the command handler
  - [ ] 9.1 Update `src/extension.ts` with the full pipeline
  ...
  - [ ] 9.2 Implement Call Graph serialization for postMessage transmission
